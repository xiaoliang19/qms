...
<body>
	...
	<%-- <div class="footer">
		Copyright &copy; 2019-${fns:getConfig('copyrightYear')} <a href="http://www.forehope-elec.com/">${fns:getConfig('productName')}</a> - Powered By <a href="http://www.forehope-elec.com/" target="_blank">JeeSite</a> ${fns:getConfig('version')}
	</div> --%>
